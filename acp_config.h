...
#define ACP_CONFIG_STRING \
    "ACP " ACP_STRINGIFY(ACP_VERSION_MAJOR) "." \
           ACP_STRINGIFY(ACP_VERSION_MINOR) "." \
           ACP_STRINGIFY(ACP_VERSION_PATCH) \
    " (" ACP_PLATFORM_NAME "/" ACP_ARCH_NAME "/" ACP_COMPILER_NAME "/" ACP_BUILD_TYPE ")"
